<ul class="sidebar-menu mt-20">
    ...
    <li <?= isset($menu) && $menu == 'revenues' ? ' class="active"' : ''?> >
        <a href="{{ url(\Config::get('adminPrefix').'/') }}"><i class="fa fa-book"></i><span>Cards</span></a>
    </li>
    @endif
            ...
            <ul class="treeview-menu">
                @if (Common::has_permission(\Auth::guard('admin')->user()->id, 'view_investment_plan'))
                    ...
                    <li <?= isset($sub_menu) && $sub_menu == 'investment_plans' ? ' class="active"' : ''?> >
                        <a href="{{ route('investment_plans.list') }}"><i class="fa fa-exchange"></i><span>{{ __('Investment Plan') }}</span></a>
                    </li>
                @endif
                ...
                @if (Common::has_permission(\Auth::guard('admin')->user()->id, 'view_investment_setting'))
                    ...
                    <li <?= isset($sub_menu) && $sub_menu == 'investment_settings' ? ' class="active"' : ''?> >
                        <a href="{{ route('investment_setting.add') }}"><i class="fa fa-cogs"></i><span>{{ __('Investment Setting') }}</span></a>
                    </li>
                @endif
            </ul>
        </li>
