        ...
        if ($transaction->count() > 0)
        {
            switch ($transaction->transaction_type_id)
            {
                ...
                case (module('Investment') ? Investment : false):
                    ...
                    $pm = (optional($transaction->payment_method)->name == 'Mts') ? settings('name') : optional($transaction->payment_method)->name ;
                    ...
                    "<div> <p>" . optional($transaction->currency)->code . "</p></div>" .
                        ...
                        "<div><p>" . $plan . ' - ' . $time_frame . ' ' . investmentInterestRateType($transaction->invest) . __(' for ')  . $term . ' ' . $term_type . "</p></div>" .
                        "</div>".
